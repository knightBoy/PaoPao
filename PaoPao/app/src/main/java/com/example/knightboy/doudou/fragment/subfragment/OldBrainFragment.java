 ...
 */
public class OldBrainFragment extends Fragment implements XListView.IXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.fragment_brain_fragment_old,container,false);
        //获得控件
        xListView = (XListView)rootview.findViewById(R.id.xlistview_brain_old);
        //必要操作
    ...
    private void initData(){
        for(int i = 0;i < 15; i++){
            ...
            brainBean.setType("青春故事");
            brainBean.setContent(getResources().getString(R.string.brain_string2));
            brainBean.setGoodNum(30);
            brainBean.setUserId(1);
            brainBean.setBgDrawableId(R.drawable.bg_2);
